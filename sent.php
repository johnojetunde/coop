...
<!--===========================FreiChatX=======END=========================-->                            
        <meta charset="UTF-8">
        <title>Cop Loan User | Sent</title>
...
echo '<div class="alert alert-info alert-dismissable" style="width:80%; margin: 0 auto;">
                                        ...
                                        <b>Alert!</b> '.$counter.' Sent Message(s) has been deleted while '.$minus.' Sent Message(s) was not deleted. '.$noexists.' Sent Message(s) not found in the database. It might have been deleted before.
                                    </div>';
}
...
echo '<div class="alert alert-info alert-dismissable" style="width:80%; margin: 0 auto;">
                                        <i class="fa fa-info"></i>
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                        <b>Alert!</b> '.$counter.' Sent Message(s) has been moved to junk '.$minus.' Sent Message(s) was not moved. '.$noexists.' Sent message(s) not found in the database. It might have been deleted before.
                                    </div>';
}
                        ...
                        <div class="col-xs-12">
                            <div class="box box-solid">
                                <div class="box-body">
                                   ...
                                   <?php 
								   if(isset($_GET['shakisendkey'])){
								   $id = stripslashes($_GET['shakisendkey']);
								   $id = decoder($id);
								   individual_sent($id,$back_page);
								   }
								   else if(isset($_GET['current_page'])){
											$currpage = mysql_real_escape_string(stripslashes($_GET['current_page']));
bring_sent_listing($username,$currpage,$back_page);
										...
										bring_searched_sent_listing($username,$currpage,$back_page,$mixedval);
										}
