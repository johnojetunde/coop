...
echo '<div class="alert alert-info alert-dismissable" style="width:80%; margin: 0 auto;">
                                        ...
                                        <b>Alert!</b> '.$counter.' Junk(s) has been deleted while '.$minus.' junk(s) was not deleted. '.$noexists.' junk(s) not found in the database. It might have been deleted before.
                                    </div>';
}
					?>
                </section>
                            ...
                            <div class="box box-solid">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-3 col-sm-4">
                                            ...
                                            <div style="margin-top: 15px;">
                                               <ul class="nav nav-pills nav-stacked">
                                                    ...
                                                    <li class="active"><a href="junk.php"><i class="fa fa-folder"></i> Junk</a></li>
                                                </ul>
                                            </div>
                                        </div><!-- /.col (LEFT) -->
                                       <?php 
									   ...
									   bring_junk_listing($username,$currpage,$back_page);
									   }
									   else if(isset($_GET['shakijunkJEG'])){
									   $id = stripslashes($_GET['shakijunkJEG']);
									   $junkid = decoder($id);
									   
									   individual_junk($junkid,$back_page);
									   }
									   
									   else if(isset($_POST['search'])){
										$currpage = 0;
										$mixedval = mysql_real_escape_string(stripslashes($_POST['mixedval']));
										bring_searched_junk_listing($username,$currpage,$back_page,$mixedval);
										}
